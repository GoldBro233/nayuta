...
The small `contentEntryUpdates` integration in `astro.config.ts` invalidates the dev
module graphs when discovered Astro entry/sidebar files are added or removed;
